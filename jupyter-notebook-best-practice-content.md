...
To achieve a higher level of discoverability, it is recommended that CEOS agencies compile metadata in compliance with the CEOS Service Discovery Best Practice.

<https://ceos.org/document_management/Working_Groups/WGISS/Documents/WGISS%20Best%20Practices/CEOS-Service-Discovery-Best-Practices.pdf> 

It is recommended to use the schema.org (CreativeWork) encoding for the embedded metadata.
